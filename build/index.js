...
var AppStorage = (function () {
    ...
    AppStorage.verifyPassword = function (key, password, okPhrase) {
        return __awaiter(this, void 0, void 0, function () {
            var encryptedMasterpass, masterkey, decryptedMasterpass, obfuscatekey, validate, OK, PHRASE, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 3:
                        ...
                        obfuscatekey = decryptedMasterpass.substr(0, decryptedMasterpass.length - 24);
                        validate = decryptedMasterpass.substring(decryptedMasterpass.length - 24);
